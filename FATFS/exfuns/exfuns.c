...
u8 exfuns_init(void)
{
	...
	data_log=(FIL*)mymalloc(SRAMIN,sizeof(FIL));		//为file申请内存
	data_log_1=(FIL*)mymalloc(SRAMIN,sizeof(FIL));		//为file申请内存
	vid_log =(FIL*)mymalloc(SRAMIN,sizeof(FIL));		//为file申请内存
	offline=(FIL*)mymalloc(SRAMIN,sizeof(FIL));		//为file申请内存
